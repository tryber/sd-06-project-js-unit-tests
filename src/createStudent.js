/*
  ...
  retorne um objeto que contenha duas chaves:
    ...
    (2) feedback, contendo uma função que retorna a nickName 'Eita pessoa boa!' ao ser chamada.
...
const createStudent = nickName => ({ name: `${nickName}`, feedback: () => ('Eita pessoa boa!') });
