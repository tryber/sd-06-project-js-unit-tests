...
describe('#circle', () => {
  it('given a radius, should return an object with circles info', () => {
    ...
    assert.ok(parseFloat((circle(3).radius).toPrecision(4)) === 3 && parseFloat((circle(3).area).toPrecision(4)) === 28.26 && parseFloat((circle(3).circumference).toPrecision(4)) === 18.84);
  });
});
