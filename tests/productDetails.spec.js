...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual((productDetails('Alcool gel', 'Máscara')[0].details['productId']).endsWith(123) && (productDetails('Alcool gel', 'Máscara')[1].details['productId']).endsWith(123), true)
  });
});
