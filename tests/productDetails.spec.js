...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // Array.isArray retorna se a função dentro dela é uma array já que por implementação do Js array por typeof é object
    ...
    //endswit('') determina se uma string termina com os caracteres dentro ('')
