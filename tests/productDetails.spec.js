...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const [produto1, produto2] = productDetails('Alcool gel', 'Máscara');
    assert.notDeepEqual(produto1, produto2);
    // (Difícil) Teste que os dois productIds terminam com 123.
    assert.deepStrictEqual([produto1, produto2].map(retornar => retornar.details.productId.slice(-3)), ['123', '123']);
  });
});
