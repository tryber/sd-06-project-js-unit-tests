...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    output = createMenu(testMenu);
    assert.deepStrictEqual(testMenu, output.fetchMenu);
    // ```
    ...
    output.order('agua');
    output.order('coxinha');
    assert.deepStrictEqual(output.consumption, ['coxinha', 'agua', 'coxinha']);
    // ```
    ...
    output.order('agua');
    output.order('coxinha');
    assert.deepStrictEqual(output.pay(), 12.87);
    // ```
