...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    let test = createMenu({ food: {}, drink: {} });

    assert.deepStrictEqual(test.fetchMenu, createMenu({ food: {}, drink: {} }).fetchMenu, 'Not same');
    ...
    test = createMenu({ food: {}, drink: {} });

    assert.deepStrictEqual(createMenu({ food: {}, drink: {} }).consumption, test.consumption, 'Not [] ');
    ...
    assert.deepStrictEqual(test.consumption, ['coxinha'], 'Not ["coxinha"]');
    ...
    assert.deepStrictEqual(test.consumption, ['coxinha', 'agua', 'sopa', 'sashimi'], 'Teste');
    ...
    assert.deepStrictEqual(test.consumption, ['coxinha', 'agua', 'coxinha'], 'Teste');
    ...
    test = createMenu({ food: { coxinha: 3.00 }, drink: { agua: 1.00 } });

    test.order('coxinha');
    test.order('agua');
    test.order('coxinha');
    assert.equal(test.pay(), 7.70, 'Not 7.70');
