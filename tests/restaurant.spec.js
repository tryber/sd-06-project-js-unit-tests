...
const objetoRetornado = createMenu({food: {'batata': 4.50, 'arroz': 2, 'feijao': 50},drink: {'coca': 10, 'soda': 5}});
...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(objetoRetornado.fetchMenu, {food: {'batata': 4.50, 'arroz': 2, 'feijao': 50},drink: {'coca': 10, 'soda': 5}});
    ...
    objetoRetornado.order("batata")
    assert.deepStrictEqual(objetoRetornado.consumption, ["batata"] )
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    objetoRetornado.order("arroz");
    objetoRetornado.order("coca");
    objetoRetornado.order("feijao");
    assert.deepStrictEqual(objetoRetornado.consumption, ['batata', 'arroz', 'coca', 'feijao'])
    ...
    objetoRetornado.order('batata');
    assert.deepStrictEqual(objetoRetornado.consumption, ['batata', 'arroz', 'coca', 'feijao', 'batata'])
    ...
    // ```
    assert.deepStrictEqual(objetoRetornado.pay(), 71)
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
