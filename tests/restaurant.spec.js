...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(fetchMenu(), anyObject);
    ...
    // ```
    const fetchMenuKeys = Object.keys(returnedObject.fetchMenu());
    ...
    // ```
    // const objetoRetornado = createMenu(anyObject);
    // objetoRetornado.fetchMenu // Retorno: objetoQualquer
    // ```
    assert.deepStrictEqual(returnedObject.fetchMenu(), anyObject);
    ...
    // ```
    returnedObject.order('coxinha');
    // objetoRetornado.comsuption // Retorno: ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha']
    // ```
