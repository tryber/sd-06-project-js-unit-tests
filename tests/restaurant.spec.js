...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const meuRestaurante = createMenu(objRestaurante);
    ...
    // ```
    // assert.deepStrictEqual(meuRestaurante.fetchMenu(), objRestaurante);
    ...
    assert.deepStrictEqual(meuRestaurante.consumption, ['coxinha', 'agua', 'sopa', 'sashimi']);
    // Agora faça o TESTE 7 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 7: Verifique que a função `order` aceita que pedidos repetidos sejam acrescidos a consumption.
    const restaurante = createMenu(objRestaurante);
    ...
    const preco = (objRestaurante.food.coxinha * 2) + objRestaurante.drinks.agua;
    assert.strictEqual(restaurante.pay(), 1.1 * preco);
