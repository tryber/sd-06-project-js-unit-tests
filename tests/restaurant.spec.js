...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    let keys = returnedObject.fetchMenu();

    assert.deepStrictEqual(Object.keys(keys), ['food', 'drink']);
    ...
    assert.deepStrictEqual(menu, keys);
    ...
    returnedObject.order('coxinha');
    let totalSum = 11.70;
    assert.equal(returnedObject.pay(), totalSum);
