...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(typeof createMenu(objetoQualquer), 'object');
    ...
    const objetoRetornado2 = createMenu(objetoQualquer3);
    objetoRetornado2.order('coxinha');
    objetoRetornado2.order('agua');
    objetoRetornado2.order('coxinha');
    // objetoRetornado.pay() // Retorno: somaDosPreçosDosPedidos
    // ```
    assert.strictEqual(objetoRetornado2.pay(), 11.7);
