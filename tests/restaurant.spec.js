...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const firstTest = createMenu('objetoQualquer');
    assert.strictEqual(firstTest.fetchMenu, 'objetoQualquer');
    ...
    let testMenu = { food: {}, drink: {} };
    const secTest = createMenu(testMenu);
    assert.deepStrictEqual(secTest.fetchMenu, { food: {}, drink: {} });
    // ```
    ...
    testMenu = { food: {}, drink: {} };
    const thirdTest = createMenu(testMenu);
    assert.deepStrictEqual(testMenu, thirdTest.fetchMenu);
    // ```
    ...
    testMenu = { food: {}, drink: {} };
    const fourthTest = createMenu(testMenu);
    assert.deepStrictEqual(fourthTest.consumption, []);
    // ```
    ...
    testMenu = { food: {}, drink: {} };
    const fifthTest = createMenu(testMenu);
    fifthTest.order('coxinha');
    assert.deepStrictEqual(fifthTest.consumption, ['coxinha']);
    // ```
    ...
    testMenu = { food: {}, drink: {} };
    const sixthTest = createMenu(testMenu);
    ...
    testMenu = { food: {}, drink: {} };
    const seventhTest = createMenu(testMenu);
    ...
    const lastTest = createMenu(myRestaurant);
    lastTest.order('coxinha');
    lastTest.order('agua');
    lastTest.order('coxinha');
    assert.deepStrictEqual(lastTest.pay(), 12.87);
    // ```
