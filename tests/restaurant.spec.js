...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    myRestaurant = createMenu(menu);
    assert.deepStrictEqual(Object.keys(myRestaurant.fetchMenu()), Object.keys(menu));
    ...
    myRestaurant = createMenu(menu);
    assert.deepStrictEqual(myRestaurant.fetchMenu(), menu);
    // --------------------------------------------------------------------------------------
    ...
    // ```
    assert.deepStrictEqual(myRestaurant.consumption, []);
    ...
    // ```
    myRestaurant.order('coxinha');
    assert.deepStrictEqual(myRestaurant.consumption, ['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha']);
    ...
    myRestaurant.order('agua');
    myRestaurant.order('coxinha');
    assert.strictEqual(myRestaurant.pay(), 11.7);
