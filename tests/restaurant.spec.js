...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(createMenu(menuRestaurante).fetchMenu, menuRestaurante);
    // ```
    ...
    assert.deepStrictEqual(createMenu(objetoRetornado2).fetchMenu, objetoRetornado2);
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    objetoRetornado2.order('agua');
    objetoRetornado2.order('coxinha');
    assert.strict(objetoRetornado2.pay, 12.87);
