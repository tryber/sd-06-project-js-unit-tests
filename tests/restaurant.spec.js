...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(Object.entries(createMenu(someObject))[0], ['fetchMenu', someObject]);
    ...
    // ```
    assert.deepStrictEqual(Object.keys(returnedObject.fetchMenu), ['food', 'drink']);
    ...
    // ```
    assert.deepStrictEqual(returnedObject.fetchMenu, someObject);
    ...
    // ```
    const item = 'coxinha';
    returnedObject.order(item);
    assert.deepStrictEqual(returnedObject.consumption, [item]);
    ...
    for (index in items) {
      returnedObject.order(items[index]);
    }
    assert.deepStrictEqual(returnedObject.consumption, items);
    ...
    assert.deepStrictEqual(returnedObject.consumption, items2);
    ...
    assert.deepStrictEqual(sum, '12.87');
