...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepEqual(Object.keys(createMenu(obj))[0], 'fetchMenu');
    ...
    assert.deepEqual(Object.keys(createMenu({ food: {}, drink: {} })['fetchMenu']), ['food', 'drink']);
    ...
    assert.deepEqual((createMenu(obj).order('coxinha')).consumption, 'coxinha');
