...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const meuRestaurante4 = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    // assert.fail();
    ...
    assert.deepStrictEqual(Object.keys(meuRestaurante.fetchMenu),
    ["food", "drink"]);
    ...
    assert.deepStrictEqual(meuRestaurante.fetchMenu, {"drink": {"agua": 3.9, "cerveja": 6.9}, "food": {"coxinha": 3.9, "sopa": 9.9}});
    ...
    assert.deepEqual(meuRestaurante.consumption, []);
    ...
    meuRestaurante2.order("sashimi");
    assert.deepStrictEqual(meuRestaurante2.consumption, ["coxinha", "agua", "sopa", "sashimi"]);
    ...
    meuRestaurante3.order("coxinha");
    meuRestaurante3.order("agua");
    meuRestaurante3.order("coxinha");
    assert.deepStrictEqual(meuRestaurante3.consumption, ['coxinha', 'agua', 'coxinha']);
